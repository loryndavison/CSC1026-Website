...
function validate_DropList1() {
    ...
    if (result == "1.2") {
        ...
        writeTextIncorrect("Access Restriction", div);
    }
}

function validate_DropList2() { /*takes no parameters, checks the first answer given and then calls writeTextCorrect or writeTextIncorrect as appropriate*/
    ...
    if (result == "2.4") {
        ...
        writeTextIncorrect("Content Parsing", div);
    }
}

function validate_DropList3() { /*takes no parameters, checks the third answer given and then calls writeTextCorrect or writeTextIncorrect as appropriate*/
    ...
    if (result == "3.3") {
        ...
        writeTextIncorrect("Run external programs and applications", div);
    }
}
